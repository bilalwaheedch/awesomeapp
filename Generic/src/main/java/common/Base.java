...
public class Base {
    ...
    @Parameters({"OS","appType","deviceType", "deviceName","version","moduleName","appName","appPackage","appWaitActivity"})
    @BeforeMethod
    public void setUp(String OS,String appType,String deviceType,String deviceName,
                      String version,String moduleName,String appName,String appPackage, String appWaitActivity)throws IOException,InterruptedException{
